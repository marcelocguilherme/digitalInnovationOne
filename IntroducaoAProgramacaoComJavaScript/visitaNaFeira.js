...
const entry = '5 10'; //atribuição de teste - deve ser comentada ou deconstada para submissão na DIO
const line = entry.split(' ');



//const line = gets().split(" "); Descomente esta linha para submissão na DIO
